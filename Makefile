...
$(BIN_DIR)/main: $(OBJ_DIR)/main.o $(OBJ_DIR)/io.o $(OBJ_DIR)/gaussian.o $(OBJ_DIR)/gaussian_separable.o $(OBJ_DIR)/sobel_x.o $(OBJ_DIR)/sobel_y.o $(OBJ_DIR)/canny.o bridge.touch
	$(CXX) $(CXXFLAGS) $(filter %.o, $^) -o $@ $(LDFLAGS)
